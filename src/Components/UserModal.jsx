      ...
      {isShowing && typeof document !== "undefined"
        ? ReactDOM.createPortal(
            <div
              ...
              <div
                ref={wrapperRef}
                className="flex max-h-[90vh] w-60 max-w-xl flex-col gap-6 overflow-hidden rounded bg-white/80 backdrop-blur-md dark:bg-slate-900/90 p-6 text-slate-500 shadow-xl shadow-slate-700/10"
                id="modal"
                role="document">
                {/*        <!-- Modal header --> */}
                <header id="header-3a" className="flex items-center gap-4">
                  <h3 className="flex-1 text-xl font-medium text-sky-500">
                    User Menu
                  </h3>
                  <button
                    onClick={() => setIsShowing(false)}
                    className="inline-flex h-10 items-center justify-center gap-2 justify-self-center whitespace-nowrap rounded-full px-5 text-sm font-medium tracking-wide text-sky-500 transition duration-300 hover:bg-sky-100 hover:text-sky-600 focus:bg-sky-200 focus:text-sky-700 focus-visible:outline-none disabled:cursor-not-allowed disabled:text-sky-300 disabled:shadow-none disabled:hover:bg-transparent"
